...
public class employeeRecords extends javax.swing.JFrame {
    ...
    try {
        ...
        if (annualSalary > 500000){
            txtFieldErrors.setText("Annual Salary must be less than $500000");
        }
    } catch (NumberFormatException e) {
    ...
    try {
        ...
        // Check if the parsed date is after January 1, 2021
        Date referenceDate = dateFormat.parse("01/01/2021");
        if (startDate.before(referenceDate)) {
            txtFieldErrors.setText("Start date must be after 2020-12-31.");
            return;
        }
